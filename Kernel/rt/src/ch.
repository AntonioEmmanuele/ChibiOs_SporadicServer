...
*/
/*
   Module changes and enhancements - Copyright (C) 2021 Antonio Emmanuele @mail:antony.35.ae@gmail.com.
   Changes:bool chSchIsPreemptionRequired(void)
*/
...
bool chSchIsPreemptionRequired(void) {
  ...
  if(currp==chSporadicServerGetInstance()){
    if(currp->ending){
      currp->ending=false;
      return true;
    }
